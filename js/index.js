...
// Post Processing
const unrealBloomPass = new UnrealBloomPass(new THREE.Vector2(window.innerWidth, window.innerHeight), 0.5, 0.85, 0.1);
...
const animate = (newTime) => {
    ...
    let desiredVecocity = VELOCITYCOEEFICIENT * (currentHeight - renderAlgorithmHeight);
    ...
    let animationValue = animationCurves.cameraAnimationCurve(mappedValue + constantAnimate, maxMappingValue);
